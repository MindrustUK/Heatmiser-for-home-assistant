...
DEFAULT_NEOSTAT_MAX_TEMPERATURE = 35
DEFAULT_NEOSTAT_MIN_TEMPERATURE = 5
...
CONF_STAT_MAX_TEMPERATURE = "stat_max_temp"
...
HEATMISER_TYPE_IDS_THERMOSTAT = {1, 2, 7, 8, 9, 11, 12, 13, 15, 17, 19, 23, 24}
HEATMISER_TYPE_IDS_TIMER = {1, 2, 6, 7, 8, 9, 11, 12, 13, 15, 17, 19, 23, 24}
